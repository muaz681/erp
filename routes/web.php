...
Route::namespace('HR')->prefix('admin/hr')->name('admin.hr.')->group(function () {
    ...
    Route::get('roles', 'HumanResourcesController@roles')->name('roles')->middleware('can:role read');
    Route::post('role/save', 'HumanResourcesController@role_store')->name('role.save')->middleware('permission:role create|role update');
    Route::post('permision/save', 'HumanResourcesController@permision_store')->name('permision.save');
    Route::get('permision/reload', 'HumanResourcesController@permision_reload')->name('permision.reload');
